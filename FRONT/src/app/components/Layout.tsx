...
export function Layout() {
  ...
  return (
    <div className={`flex h-screen ${theme === 'dark' ? 'bg-slate-950 text-slate-100' : 'bg-slate-50 text-slate-900'}`} style={{ fontFamily: 'Inter, sans-serif' }}>
      {/* Sidebar */}
      <aside className={`w-64 ${theme === 'dark' ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'} border-r flex flex-col`}>
        ...
        <div className={`p-4 border-t ${theme === 'dark' ? 'border-slate-800' : 'border-slate-200'}`}>
          <div className={`flex items-center gap-2 p-3 ${theme === 'dark' ? 'bg-slate-800' : 'bg-slate-100'} rounded-lg`}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            {/* Color Picker - only in dark mode */}
            {theme === 'dark' && (
            ...
            {/* User Profile */}
            <button className={`flex items-center gap-2 px-4 py-2 ${theme === 'dark' ? 'bg-slate-800 hover:bg-slate-700' : 'bg-slate-200 hover:bg-slate-300'} rounded-lg transition-colors`}>
